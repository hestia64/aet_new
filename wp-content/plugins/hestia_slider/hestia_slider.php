...
/*  
Copyright 2013  HESTIA Multimédia  (email : contact@hestia-multimedia.fr)
...
add_action( 'widgets_init','initialisation_widget_hestia_slider');
    ...
    class widget_hestia_slider extends WP_widget {
        ...
        function widget ($args,$instance) {
            ...
            hestia_slider ($args, $this->id, $instance['title'], $instance['voir_actus'], $nom_widget_hestia_slider);
            echo '</div>';
            echo $after_widget;
        }
        ...
        function form ($instance) {
            $defaut = array(
                ...
                'type_defilement'   =>  'Fade',
                'duree_defilement'  =>  '700',
                'delai_defilement'  =>  '5000',
                'id'                =>	'0'
            );
            ...
            if ( isset( $instance[ 'type_defilement' ] ) ) {
                $type_defilement = $instance[ 'type_defilement' ];
            }
            else {
                $type_defilement = __( 'Type de défilement du slide', 'hestia_slider_traduction' );
            }
            if ( isset( $instance[ 'duree_defilement' ] ) ) {
                $duree_defilement = $instance[ 'duree_defilement' ];
            }
            else {
                $duree_defilement = 700;
            }
            if ( isset( $instance[ 'delai_defilement' ] ) ) {
                $delai_defilement = $instance[ 'delai_defilement' ];
            }
            else {
                $delai_defilement = 5000;
            }
